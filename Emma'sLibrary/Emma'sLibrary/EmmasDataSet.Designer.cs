...
namespace Emma_sLibrary.EmmasDataSetTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Emma_sLibrary.Properties.Settings.Default.EmmasConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, custFirst, custLast, custPhone, custAddress, custCity, custPost" +
                "al, custEmail, custFirst + \' \' + custLast AS custName\r\nFROM            customer\r" +
