...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <br />
            <asp:DetailsView ID="dvEmployeeNew" runat="server" AutoGenerateRows="False" DataKeyNames="id" DataSourceID="dsEmployeeNew" DefaultMode="Insert" Height="50px" OnItemCommand="dvEmployeeNew_ItemCommand" Visible="False" Width="125px">
                <Fields>
            ...
            <br />
            <asp:GridView ID="gvEmployees" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="dsEmployeesAll" OnSelectedIndexChanged="gvEmployees_SelectedIndexChanged1" EnableViewState="False">
                <Columns>
         ...
         <asp:ObjectDataSource ID="dsEmployeesAll" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="aLibrary.EmmasDataSetTableAdapters.employeesAllTableAdapter">
             <SelectParameters>
                 <asp:ControlParameter ControlID="ddlPosition" DefaultValue="0" Name="Param1" PropertyName="SelectedValue" Type="Int32" />
             </SelectParameters>
         </asp:ObjectDataSource>
         <asp:ObjectDataSource ID="dsEmployeeNew" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="aLibrary.EmmasDataSetTableAdapters.employeeNewTableAdapter" UpdateMethod="Update">
             <DeleteParameters>
         ...
         <asp:ObjectDataSource ID="dsPosition" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="aLibrary.EmmasDataSetTableAdapters.positionTableAdapter"></asp:ObjectDataSource>
        <br />
    </form>
</body>
</html>
