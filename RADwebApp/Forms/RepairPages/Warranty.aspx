...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container mt-4">
            ...
            <br />
            <asp:HyperLink CssClass="btn btn-light" ID="hlWarrantyAllRepairs" runat="server" NavigateUrl="~/Forms/RepairPages/AllRepairs.aspx">All Repairs</asp:HyperLink>
&nbsp;&nbsp;&nbsp;
            <asp:HyperLink CssClass="btn btn-light" ID="hlWarrantyOrder" runat="server" NavigateUrl="~/Forms/RepairPages/OrderTools.aspx">Order Tools</asp:HyperLink>
            <br />
            <br />
            <br />
            <asp:Button CssClass="btn btn-light" ID="btnNewWarranty" runat="server" OnClick="btnNewWarranty_Click" Text="Add New Warranty" />
            <br />
            <br />
